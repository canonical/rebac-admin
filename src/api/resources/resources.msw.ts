...
export const getGetResourcesMockHandler = (
  overrideResponse?: GetResources200,
) => {
...
export const getGetResourcesMockHandler200 = (
  ...
  return http.get("*/resources", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse ? overrideResponse : getGetResourcesResponseMock200(),
      ),
      {
        status: 200,
        headers: {
...
export const getGetResourcesMockHandler400 = (
  ...
  return http.get("*/resources", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse ? overrideResponse : getGetResourcesResponseMock400(),
      ),
      {
        status: 400,
        headers: {
...
export const getGetResourcesMockHandler401 = (
  ...
  return http.get("*/resources", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse ? overrideResponse : getGetResourcesResponseMock401(),
      ),
      {
        status: 401,
        headers: {
...
export const getGetResourcesMockHandler404 = (
  ...
  return http.get("*/resources", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse ? overrideResponse : getGetResourcesResponseMock404(),
      ),
      {
        status: 404,
        headers: {
