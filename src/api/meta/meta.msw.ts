...
export const getSwaggerJsonResponseMock200 = (): string => faker.word.sample();
...
export const getSwaggerJsonMockHandler200 = (overrideResponse?: string) => {
  return http.get("*/swagger.json", async () => {
    await delay((() => (process.env.NODE_ENV === "development" ? 1e3 : 10))());
    return new HttpResponse(
      JSON.stringify(
